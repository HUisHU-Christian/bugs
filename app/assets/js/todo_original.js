$(function(){ 
  ...
  $('.todo-lane').droppable({
    ...
    drop: function( event, ui ) {
    	alert("Nous lisons la ligne 25 qui devrait gérer le dépôt de cet élément en mouvement");
  ...
  $('a.todo-button.del').click(function(event) {
    ...
    $.post( siteurl + 'ajax/todo/remove_todo', { "issue_id" : issue_id }, 
      function( data ) {
        if (data.success) {
...
alert("Oui, nous entrons dans todo.js");