...
ALTER TABLE projects_issues_comments ADD COLUMN temps_fait_fin datetime DEFAULT NULL AFTER comment;
ALTER TABLE projects_issues_comments ADD COLUMN temps_fait_deb datetime DEFAULT NULL AFTER comment;
